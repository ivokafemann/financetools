...
print('\nThe value of your investment after {} year(s) at an interest rate of {}% is: {}'.format(t,r,annuity(P,r,t)))

#Create a list of annuities with the Annuities Function
def annuities(P,r,t):
    P1 = [annuity(P,r,x) for x in range(t)]
    return P1
